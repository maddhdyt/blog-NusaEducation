        ...
        <form action="{{ route('admin.pages.update', $page) }}" method="POST" class="space-y-5">
            ...
            <div class="space-y-2">
                ...
                <div id="content-editor" class="bg-white border border-gray-200 rounded-lg min-h-[240px]"
                    aria-label="Content editor">{!! old('content', $page->content) !!}</div>
            ...
            <div class="space-y-2">
                ...
                <textarea name="meta_description" rows="2"
                    class="w-full rounded-lg border border-gray-300 px-3 py-2 text-sm shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('meta_description') border-red-500 focus:border-red-500 focus:ring-red-500 @enderror">{{ old('meta_description', $page->meta_description) }}</textarea>
